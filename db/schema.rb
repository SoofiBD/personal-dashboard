...
ActiveRecord::Schema[7.2].define(version: 2026_09_09_000000) do
  ...
  create_table "document_conversions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.binary "source_pdf_data"
    t.integer "source_pdf_byte_size"
    ...
    t.check_constraint "source_pdf_byte_size IS NULL OR source_pdf_byte_size > 0", name: "document_conversions_source_pdf_byte_size_positive"
