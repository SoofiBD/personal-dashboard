module ApplicationHelper
  def dashboard_currency(value)
    currency = respond_to?(:current_panel_user) && current_panel_user ? current_panel_user.currency : (defined?(User) && User.respond_to?(:dashboard_owner) ? User.dashboard_owner.currency : "$")
