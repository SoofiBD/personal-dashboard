...
- ["Front End System Design Playbook" by GreatFrontEnd](https://www.greatfrontend.com/front-end-system-design-playbook?fpr=yangshun): A free system design guidebook by yours truly, focused on system design for the front end applications, e.g. how to design [Facebook's News Feed](https://www.greatfrontend.com/questions/system-design/news-feed-facebook?format=system-design), [Google autocomplete search](https://www.greatfrontend.com/questions/system-design/autocomplete?format=system-design), Image Carousels and more.
...
- ["Grokking Modern System Design Interview" course by Educative](https://www.educative.io/courses/grokking-the-system-design-interview?aff=x23W): A structured course by ex-FAANG engineers that teaches you how to design scalable systems with clarity and confidence for modern tech interviews. Contains many system design topics along with case studies.
